...
@WebServlet(name = "BrowseOtherServlet", urlPatterns = "/api/browse-other")
public class BrowseOtherServlet extends HttpServlet {
...
//                jsonArray.add(jsonObject);
            ...
            if (movieParameter == null) {
                ...
                newMovieParameter.addProperty("status", "browse-other");
